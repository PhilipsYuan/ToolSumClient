...
const parseInput = createTorrent.parseInput
const debugFactory = require("debug")
const parallel = require("run-parallel")
const parseTorrent = require("parse-torrent")
const Peer = require("@thaunknown/simple-peer/lite.js")
const queueMicrotask = require("queue-microtask")
const { hash, hex2arr, arr2hex, arr2base, text2arr, randomBytes, concat } = require("uint8-util")
const throughput = require("throughput")
const { ThrottleGroup } = require("speed-limiter")
const Torrent = require("webtorrent/lib/torrent.js")
const { NodeServer, BrowserServer } = require("webtorrent/lib/server.js")
...
class WebTorrent extends EventEmitter {
    constructor (opts = {}) {
        ...
        if (opts.secure === true) {
            import('webtorrent/lib/peer.js').then(({ enableSecure }) => enableSecure())
        }
