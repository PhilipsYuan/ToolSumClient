...
import require$$2 from 'k-bucket';
import require$$3 from 'k-rpc';
import require$$4 from 'last-one-wins';
import require$$5 from 'lru';
import require$$6 from './randombytes';
import require$$7 from 'record-cache';
import require$$8 from './simple-sha1';
...
const debug = require$$1('bittorrent-dht');
const KBucket = require$$2;
const krpc = require$$3;
const low = require$$4;
const LRU = require$$5;
const randombytes = require$$6;
const records = require$$7;
const simpleSha1 = require$$8;
const { EventEmitter } = require$$9;
