...
import require$$1 from './bittorrent-dht-client';
import require$$2 from 'events';
import require$$3 from 'run-parallel';
import require$$4 from './bittorrent-tracker-client';
import require$$5 from 'bittorrent-lsd';
...
const debug = require$$0('torrent-discovery');
const DHT = require$$1; // empty object in browser
const EventEmitter = require$$2.EventEmitter;
const parallel = require$$3;
const Tracker = require$$4;
const LSD = require$$5;
