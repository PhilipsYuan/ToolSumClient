import require$$0$1 from 'bencode';
import require$$1$1 from 'block-iterator';
import require$$2$1 from 'piece-length';
import require$$0 from 'path';
import require$$4$1 from 'is-file';
import require$$2 from 'junk';
import require$$6 from 'join-async-iterator';
import require$$4 from 'run-parallel';
import require$$8 from 'queue-microtask';
import require$$9 from './simple-sha1';
import 'fast-readable-async-iterator';
import require$$1 from 'fs';
import require$$3 from 'once';

function getDefaultExportFromCjs (x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}

var createTorrent = {exports: {}};

const corePath = require$$0;
const fs = require$$1;
const junk = require$$2;
const once = require$$3;
const parallel = require$$4;
...
var getFiles_1 = getFiles;

/*! create-torrent. MIT License. WebTorrent LLC <https://webtorrent.io/opensource> */

(function (module) {
	const bencode = require$$0$1;
	const blockIterator = require$$1$1;
	const calcPieceLength = require$$2$1;
	const corePath = require$$0;
	const isFile = require$$4$1;
	const junk = require$$2;
	const joinIterator = require$$6;
	const parallel = require$$4;
	const queueMicrotask = require$$8;
	const sha1 = require$$9;


	const getFiles = getFiles_1; // browser exclude
...
var createTorrentExports = createTorrent.exports;
var index = /*@__PURE__*/getDefaultExportFromCjs(createTorrentExports);
