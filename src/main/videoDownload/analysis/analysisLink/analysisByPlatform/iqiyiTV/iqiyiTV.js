...
import { auth } from "./iqiyi.js";
// import { global} from "./cmd5x.js";
import md5 from 'md5'
...
const build_cmd5x = function(module, exports, __webpack_require__) {
...
global.parse_vf = function(url_with_dash_but_vf){
    ...
    r = r.replace("/3ea/420a8433732a6c99d1eae98fea69e55d", "")
    const n = cmd5x_exports.cmd5x(r);
...
// const url_vf = args[0]
//
// console.log(global.parse_vf(url_vf))



// ----------------

async function getInfo (htmlUrl) {
    ...
    const params = {
        ...
        bop: '{"version":"10.0","dfp":"a0ecf8e4c6312b4cb6b07659066e7caca9279d3d666b49de92ddf17cab892223b9"}', // 需要处理
        ut: 0,
        // vf: '' // 需要处理
    }
    let temp = '/dash?'
    for(let key in params) {
        temp = temp + key + '=' + params[key].toString() +'&'
    }
    temp = temp.substring(0, temp.length-1)
    // console.log(temp)
    const vfString = global.parse_vf(temp)
    console.log(md5(temp))
    console.log(vfString)
    params.vf = vfString

    // axios.get("https://cache.video.iqiyi.com/dash", {
    //     params
    // })
    //     .then((res) => {
...
// 30ff4d4c33c40c2e2824436a5f9e5a67
const string = '/dash?tvid=7840870351087700&bid=300&vid=&src=01080031010000000000&vt=0&rs=1&uid=&ori=pcw&ps=0&k_uid=80f0bd95358b2c98c3107bd7091ebd5b&pt=0&d=0&s=&lid=0&cf=0&ct=0&authKey=366a77c84f1f9a6d7062de3136b0b5f5&k_tag=1&dfp=a0ecf8e4c6312b4cb6b07659066e7caca9279d3d666b49de92ddf17cab892223b9&locale=zh_cn&pck=&k_err_retries=0&up=&sr=1&qd_v=5&tm=1704269039092&qdy=u&qds=0&ppt=0&k_ft1=706436220846852&k_ft4=1162321298202628&k_ft2=262335&k_ft5=134217729&k_ft6=128&k_ft7=755499012&fr_300=120_120_120_120_120_120&fr_500=120_120_120_120_120_120&fr_600=120_120_120_120_120_120&fr_800=120_120_120_120_120_120&fr_1020=120_120_120_120_120_120&bop=%7B%22version%22%3A%2210.0%22%2C%22dfp%22%3A%22a0ecf8e4c6312b4cb6b07659066e7caca9279d3d666b49de92ddf17cab892223b9%22%2C%22b_ft1%22%3A8%7D&ut=0'
console.log(md5(string))
console.log(global.parse_vf(string))
